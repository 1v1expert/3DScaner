...
__title__ = "Updated horus " + __version__
...
class MainWindow(wx.Frame):
    ...
    def load_workbenches(self):
        ...
        self.workbench['convert'] = ConvertWorkbench(self, self.toolbar.toolbar_convert,
                                                     ...
                                                     self.normals_calculation_callback,
    ...
    def normals_calculation_callback(self, is_success):
        if is_success:
            self._show_message(_("Normals calculation"), wx.ICON_ASTERISK, _('Normals calculation success'))
        else:
            self._show_message(_("Normals calculation"), wx.ICON_ERROR, _("Normals calculation error"))

    def reconstruction_callback(self, is_success):
        if is_success:
            self._show_message(_("Reconstruction"), wx.ICON_ASTERISK, _('Mesh reconstruction success'))
        else:
