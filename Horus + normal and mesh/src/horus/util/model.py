...
class Mesh(object):
    ...
    def calculate_normals_with_normal_estimation(self, **kwargs):
        estimator = NormalEstimation(self, **kwargs)
        estimator.run_and_wait()
        self.normal = estimator.get_normals()
        self.has_normals = True
        return self.normal

    def reconstruct_poisson(self, **kwargs):
        reconstruction = PoissonReconstruction(self, **kwargs)
        reconstruction.run_and_wait()
        return reconstruction.output_name
